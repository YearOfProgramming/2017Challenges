...
- My solution loops through the input one time, checking to see if each element was repeated by using sets to keep track of unique elements.
- There are three test cases: The two arrays given in the prompt and one more array that does not have an unrepeated element
- Call `python main.py' to search for un-repeated elements in the three test cases
